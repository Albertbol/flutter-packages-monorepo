...
class ScreenTextExtractor {
  ...
  Future<bool> _simulateCopyKeyPress() async {
    return await _channel.invokeMethod('simulateCopyKeyPress', {});
  }

  Future<bool> paste(String text) async {
    await Clipboard.setData(ClipboardData(text: text));
    return await _channel.invokeMethod('simulatePasteKeyPress', {});
  }
